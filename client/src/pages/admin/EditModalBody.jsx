...
import { toggleEditModelFunc } from "../../redux/slices/generalSlice";
...
export default function EditModalBody({
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, bag) => {
      ...
      if (!id && !updatedProductData) console.log("undefined values");
      try {
        console.log(loading);
  ...
  const handleFileInputChange = async (e) => {
    ...
    if (formik.values.images?.length + files?.length > max) {
